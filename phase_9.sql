...
create index amount_index on distribution(amount);
create index phone_index on customer(phone);
create index brandName_index on brand(brandName);
create index weight_index on product(weight);