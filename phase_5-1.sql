...
INSERT INTO product VALUES (181818181818, 56, 'p13', 'b1');
INSERT INTO product VALUES (191919191919, 52, 'p1', 'b1');
INSERT INTO product VALUES (202020202020, 55, 'p13', 'b1');
INSERT INTO product VALUES (242424242424, 5, 'p12', 'b1');
INSERT INTO product VALUES (252525252525, 5, 'p3', 'b1');
INSERT INTO product VALUES (262626262626, 4, 'p4', 'b1');
...
INSERT INTO order_product VALUES (28,1,181818181818);
INSERT INTO order_product VALUES (29,1,191919191919);
INSERT INTO order_product VALUES (30,1,202020202020);
INSERT INTO order_product VALUES (31,1,242424242424);
INSERT INTO order_product VALUES (32,1,252525252525);
INSERT INTO order_product VALUES (33,1,262626262626);
...
INSERT INTO order_product VALUES (34,2,202020202020);
INSERT INTO order_product VALUES (35,2,242424242424);
INSERT INTO order_product VALUES (36,2,252525252525);
INSERT INTO order_product VALUES (37,2,262626262626);
...
INSERT INTO order_product VALUES (27,3, 151515151515);

INSERT INTO purchased VALUES (1,'d1',100000000000);
INSERT INTO purchased VALUES (2,'d1',200000000000);
INSERT INTO purchased VALUES (3,'d1',300000000000);

INSERT INTO purchased VALUES (4,'d2',400000000000);
INSERT INTO purchased VALUES (5,'d2',100000000000);
INSERT INTO purchased VALUES (6,'d2',500000000000);


/*1*/


SELECT purchased.distName, product.name, count(product.name) as total_amount
FROM ordered
JOIN order_product ON ordered.orderId = order_product.orderId
JOIN product ON order_product.barcode = product.barcode
JOIN purchased ON ordered.nationalId = purchased.nationalId
GROUP BY purchased.distName, product.name
HAVING (count(purchased.distName) < 10)
ORDER BY purchased.distName, total_amount DESC;
